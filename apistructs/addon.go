...
const (
	...
	AddonMysqlInitURL                  string = "/api/addon-mysql/init"
	AddonMysqlcheckStatusURL           string = "/api/addon-mysql/check"
	AddonMysqlExecURL                  string = "/api/addon-mysql/exec"
	AddonMysqlExecFileURL              string = "/api/addon-mysql/exec_file"
