...
require (
	...
	github.com/kubeflow/spark-operator v0.0.0-20240605143903-5ce3dbacff76
...
replace (
	...
	github.com/rancher/remotedialer => github.com/erda-project/remotedialer v0.2.6-0.20250107054043-004305a8e459
