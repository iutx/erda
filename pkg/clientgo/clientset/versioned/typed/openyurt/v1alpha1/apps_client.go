...
// NewOpenYurtClientWithConfig creates a new AppsV1alpha1Client for the given kubeconfig
func NewOpenYurtClientWithConfig(restConfig *rest.Config) (*AppsV1alpha1Client, error) {
