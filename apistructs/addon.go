...
const (
	ServiceTypeLabel    = "DICE_SERVICE_TYPE"
...
const (
	...
	AddonRedisEmptyPassword            string = "erda@empty"
	...
	AddonMysqlMasterGrantBackupSqls    string = "CREATE USER IF NOT EXISTS 'backup'@'%' IDENTIFIED BY '${MYSQL_ROOT_PASSWORD}'; GRANT REPLICATION SLAVE ON *.* to 'backup'@'%';"
	AddonMysqlCreateMysqlUserSqls      string = "CREATE USER 'mysql'@'%' IDENTIFIED WITH mysql_native_password BY '${MYSQL_ROOT_PASSWORD}';"
	...
	AddonMysqlExternalHostName         string = "MYSQL_EXTERNAL_HOST"
	AddonMysqlExternalWritePortName    string = "MYSQL_EXTERNAL_WRITE_PORT"
	AddonMysqlExternalReadPortName     string = "MYSQL_EXTERNAL_READ_PORT"
	...
	AddonCanalExternalHostName         string = "CANAL_EXTERNAL_HOST"
	AddonCanalPortName                 string = "CANAL_PORT"
	AddonCanalExternalPortName         string = "CANAL_EXTERNAL_PORT"
	AddonCanalDefaultPort              string = "11111"
	AddonEsHostName                    string = "ELASTICSEARCH_HOST"
	AddonEsExternalHostName            string = "ELASTICSEARCH_EXTERNAL_HOST"
	AddonEsPortName                    string = "ELASTICSEARCH_PORT"
	AddonEsExternalHttpPortName        string = "ELASTICSEARCH_EXTERNAL_HTTP_PORT"
	AddonEsExternalTransportPortName   string = "ELASTICSEARCH_EXTERNAL_TCP_PORT"
	...
	AddonKafkaExternalHostName         string = "KAFKA_EXTERNAL_HOST"
	AddonKafkaManager                  string = "manager"
	AddonKafkaPortName                 string = "KAFKA_PORT"
	AddonKafkaExternalPortName         string = "KAFKA_EXTERNAL_PORT"
	...
	AddonRocketConslePrefix            string = "console"
	AddonRocketBrokerPrefix            string = "broker"
	AddonRocketNameSrvHost             string = "ROCKETMQ_NAMESRV_HOST"
	AddonRocketNameSrvExternalHost     string = "ROCKETMQ_NAMESRV_EXTERNAL_HOST"
	AddonRocketNameSrvPort             string = "ROCKETMQ_NAMESRV_PORT"
	AddonRocketNameSrvExternalPort     string = "ROCKETMQ_NAMESRV_EXTERNAL_PORT"
	AddonRocketBrokerExternalHost      string = "ROCKETMQ_BROKER_EXTERNAL_HOST"
	AddonRocketConsoleExternalHost     string = "ROCKETMQ_CONSOLE_EXTERNAL_HOST"
	...
	AddonZKExternalHostName            string = "ZOOKEEPER_EXTERNAL_HOST"
	AddonZKPortName                    string = "ZOOKEEPER_PORT"
	AddonZKExternalPortName            string = "ZOOKEEPER_EXTERNAL_PORT"
	...
	AddonRedisExternalHostName         string = "REDIS_EXTERNAL_HOST"
	AddonRedisMasterExternalHostName   string = "REDIS_MASTER_EXTERNAL_HOST"
	AddonRedisSentinelExternalHostName string = "REDIS_SENTINEL_EXTERNAL_HOST"
	AddonRedisPortName                 string = "REDIS_PORT"
	AddonRedisExternalPortName         string = "REDIS_EXTERNAL_PORT"
	AddonRedisSentinelExternalPortName string = "REDIS_SENTINEL_EXTERNAL_PORT"
	...
	AddonRabbitmqExternalHostName      string = "RABBIT_EXTERNAL_HOST"
	AddonRabbitmqExternalPortName      string = "RABBIT_EXTERNAL_PORT"
	AddonRabbitmqExternalOtherPortName string = "RABBIT_EXTERNAL_OTHER_PORT"
