...
func NewCustomClientSetWithConfig(restConfig *rest.Config) (*Clientset, error) {
	...
	cs.flinkoperatorV1beta1, err = flinkoperatorv1beta1.NewFlinkOpeartorClientWithConfig(restConfig)
	if err != nil {
		return nil, err
	}

	cs.sparkoperatorV1beta1, err = sparkoperatorv1beta1.NewSparkOpeartorClientWithConfig(restConfig)
	if err != nil {
		return nil, err
	}

	cs.sparkoperatorV1beta2, err = sparkoperatorv1beta2.NewSparkOpeartorClientWithConfig(restConfig)
	if err != nil {
		return nil, err
	}

	cs.openYurtV1alpha1, err = openYurtV1alpha1.NewOpenYurtClientWithConfig(restConfig)
	if err != nil {
		return nil, err
	}
	...
	cs.redisfailoverV1, err = redisfailoverv1.NewRedisFailoverClientWithConfig(restConfig)
	if err != nil {
		return nil, err
	}
