...
func NewForConfig(c *rest.Config) (*FlinkoperatorV1beta1Client, error) {
	config := *c
	...
	return &FlinkoperatorV1beta1Client{client}, nil
}
...
// NewFlinkOpeartorClientWithConfig creates a new OperatorV1beta1 for the given kubeconfig
func NewFlinkOpeartorClientWithConfig(restConfig *rest.Config) (*FlinkoperatorV1beta1Client, error) {
