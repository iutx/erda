...
// NewRedisFailoverClientWithConfig creates a new DatabasesV1Client for the given kubeconfig
func NewRedisFailoverClientWithConfig(restConfig *rest.Config) (*DatabasesV1Client, error) {
