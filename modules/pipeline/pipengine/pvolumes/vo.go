...
var (
	ContainerRootDir     = "/tmp/pipeline-container"
	...
	ContainerVolumeMountRootDir = "/tmp/pipeline-context"                  // task volume 的挂载目录的父目录
	ContainerDiceFilesDir       = "/tmp/pipeline-container/cms/dice_files" // cms dice files 类型在运行时的挂载目录
)
